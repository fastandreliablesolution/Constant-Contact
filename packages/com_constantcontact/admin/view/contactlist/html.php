 ...
 * @since		1.1
 */
class ConstantcontactViewContactlistHtml extends JViewLegacy
{
    public function display($tpl = null)
    {
        $modelContact = JModelLegacy::getInstance('contactlist','constantcontactModel');
    ...
    public function addToolbar()
    {
        ...
        if ($canDo->get('core.edit')) {
            JToolBarHelper::apply('contactlist.apply');
            JToolBarHelper::save('contactlist.save');
        }

        JToolBarHelper::cancel('contactlist.cancel', 'JTOOLBAR_CLOSE');
    }
}